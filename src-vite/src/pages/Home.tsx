...
export default function Home() {
    return (
        ...
        <div className="Home bg-gradient-to-r from-blue-500 to-purple-600 min-h-screen flex flex-col items-center text-white p-8 justify-center">
            ...
            >
                Troubleshoot your PS5 controller with real-time input monitoring, drift analysis, and connectivity tests. <br />
                Diagnose issues fast and keep your DualSense in peak condition. Test, fix, and game on!
            </motion.h3>
