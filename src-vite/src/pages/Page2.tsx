...
function CircleCanvas({ canvasWidth, canvasHeight, outlineRadius, joystickRadius, points, lineWidth, translation }: CircleCanvasParams): JSX.Element {
    ...
    const initWebGL = () => {
        ...
        outlinePositionLocationRef.current = gl.getAttribLocation(shaderProgram, "a_position");
        joystickPositionLocationRef.current = gl.getAttribLocation(shaderProgram, "a_position");
        translationLocationRef.current = gl.getUniformLocation(shaderProgram, "u_translation");
